...
class DbmngHelperTest extends \PHPUnit_Extensions_Database_TestCase
{
    ...
    public function getDataSet() {
      ...
      $aFormID = $h->getFormArrayById(1);
      $aFormName = $h->getFormArrayByName('test');
      $aFormAlias = $h->getFormArrayByAlias('alias_test');
      // print_r($aFormAlias);

      $this->assertEquals($aFormID, $aFormName);
      $this->assertEquals($aFormID, $aFormAlias);
		}
}
